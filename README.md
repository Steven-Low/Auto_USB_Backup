...
Auto_USB_Backup is a Window script program that automate download of files into usb drive when triggered by usb insertion.

# Manual Installation 
- Clone the repo in somewhere
...
- For the action, select start a program and specify the path of **executepy.cmd**
...
- Clone the repo in somewhere
- Execute the **install.cmd** script
- Don't forget to modify the **pullusb.py** file with your own details
